import useEstadisticasEspacio from "../hooks/getEstadisticasEspacio";

const EstadisticasEspacioModal = ({ id, context, isOpen, closeModal }) => {
    const { tableros, listas, actividades, estadisticas } = useEstadisticasEspacio(id);
                ...
                <div className="bg-purple-100 p-2 rounded-md mb-4">
                    ...
                    <div className="flex justify-between mt-2">
                        <div>
                            ...
                            <p className="text-lg font-bold text-gray-900">{estadisticas.tablerosTotales}</p>
                        </div>
                        <div>
...
export default EstadisticasEspacioModal;
